   ...
   <div class="row py-2">
      ...
      <div class="col-xl-4 col-md-4 col-12">
         <div class="d-flex align-items-center justify-content-end gap-2">
            <a href="{{route('menus.create')}}" class="theme-btn rounded-2 float-end">
               <i class="bi bi-plus-lg" aria-hidden="true"></i> CREATE</a>
            <a href="{{route('menus.list')}}" class="theme-btn rounded-2 float-end">
      ...
      <div class="row align-items-end justify-content-center">
         ...
         <div class="col-lg-3 col-md-6 col-12 mb-3">
            <div class="d-flex align-items-center gap-2">
               <button type="submit" class="theme-btn rounded-2 py-2 px-4">Search</button>
               <a href="{{ route('menus.child.list',$id) }}" class="border-btn rounded-2 py-2 px-4">Reset</a>
            </div>
         </div>
      </div>
   </form>
               ...
               <tbody>
                  ...
                  <tr>
                     ...
                     <td>
                        ...
                        <a href="{{ route('menus.list',$menu->id) }}">
