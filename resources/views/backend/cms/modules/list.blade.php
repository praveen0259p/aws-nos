...
<div class="container-fluid">
    <div class="row py-2">
        ...
        <div class="col-xl-4 col-md-4 col-12">
            <a href="{{route('modules.create')}}" class="theme-btn rounded-2 float-end"><i class="bi bi-plus-lg" aria-hidden="true"></i> CREATE</a>
        </div>
    </div>
    @if(session('success'))
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="{{ route('modules.child.list',encrypt($module->module_id)) }}">
